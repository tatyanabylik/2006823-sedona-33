...
* Студент: [Татьяна Билык](https://up.htmlacademy.ru/htmlcss/33/user/2006823).
* Наставник: `Влад Повелица.` трам тарарам
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/2006823-sedona-33) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
